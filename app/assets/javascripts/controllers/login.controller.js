angular.module('pansionatApp').controller('LoginCtrl', 
  ['$scope', '$stateParams', '$http', 'Auth', '$state', '$localStorage', '$sessionStorage', LoginCtrl]);

  function LoginCtrl($scope, $stateParams, $http, Auth, $state, $localStorage, $sessionStorage) {
