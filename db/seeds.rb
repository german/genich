...
Hotel.delete_all
Hotel.create({name: "Кобзарь", city_name: 'Геническ', dist_from_the_sea: 200, has_tv: true, has_parking: true, price_max: 20})
...
Hotel.create({name: "Элит", city_name: 'Счастливцево', dist_from_the_sea: 50, has_tv: true, has_parking: true, 
	has_conditioning: true, has_private_kitchen: true, price_max: 100})
